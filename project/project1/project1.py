...
def importNoTaxJSON(workspace=r'C:\Users\cecil\Documents\ArcGIS\Projects\GEOG4057\project1',json_file='no_tax.json',out_fc='notax_fc1.shp'):
...
def main():
    import sys
    out_fc = sys.argv[1]
    importNoTaxJSON(out_fc='notax_fc3.shp')
